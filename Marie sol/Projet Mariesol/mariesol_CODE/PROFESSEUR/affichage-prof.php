...
<head>
    ...
    <script>
        ...
        menuRequest.open('GET', 'menuPROF.html', true);
        menuRequest.send();
    </script>
...
<body>
    <header>
        <h1>Liste des professeurs de l'école</h1>
    </header>

    <section>
        <h2>Liste des professeurs de l'école</h2>
        <main>
            <?php
            ...
            if ($eleves) {
                echo "<table>";
                echo "<tr><th>Code du professeur</th><th>Code de la Discipline</th><th>Nom</th><th>Prénom</th><th>Adresse</th><th>Code postal</th><th>Ville</th><th>Téléphone</th></tr>";
                foreach ($eleves as $eleve) {
                    echo "<tr>";
                    echo "<td>" . $eleve['CODE_PROF'] . "</td>";
                    echo "<td>" . $eleve['CODE_DISCIPLINE'] . "</td>";
                    echo "<td>" . $eleve['NOM_PROF'] . "</td>";
                    echo "<td>" . $eleve['PRENOM_PROF'] . "</td>";
                    echo "<td>" . $eleve['ADR1_PROF'] . " " . $eleve['ADR2_PROF'] . "</td>";
                    echo "<td>" . $eleve['CP_PROF'] . "</td>";
                    echo "<td>" . $eleve['VILLE_PROF'] . "</td>";
                    echo "<td>" . $eleve['TEL_PROF'] . "</td>";
                    echo "</tr>";
                }
                echo "</table>";
